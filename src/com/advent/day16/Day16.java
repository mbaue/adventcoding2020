 ...
 * that one of the legs of your re-routed trip coming up is on a high-speed train.
 ...
 * in every ticket is named class and can be any value in the ranges 1-3 or 5-7
 ...
 * In any case, you've extracted just the numbers in such a way that the first number is
 * always the same specific field, the second number is always a different specific field,
 ...
 * first nearby ticket are all valid for at least one field. This is not true of
