 ...
 * that come with a little umbrella, you are interrupted by the kid sitting next to you.
 *
 ...
 * using the argument as an offset from the jmp instruction; for example, jmp +2 would skip the next instruction,
